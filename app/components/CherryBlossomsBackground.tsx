  ...
  return (
    <div
      style={{
        ...
        pointerEvents: 'none',
        zIndex: tree.layer === 'far' ? 0 : tree.layer === 'mid' ? 0 : 0,
    ...
    >
      <svg width="180" height="300" viewBox="0 0 180 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Trunk */}
        <path
          d="M85 290 Q80 250 75 200 Q70 160 65 130 Q60 100 55 80"
          stroke={trunkColor}
          strokeWidth="8"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M85 290 Q90 250 95 200 Q100 160 105 130 Q110 100 115 80"
          stroke={trunkColor}
          strokeWidth="6"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M70 180 Q55 160 40 140 Q30 130 25 120"
          stroke={trunkColor}
          strokeWidth="4"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M100 170 Q115 150 130 130 Q140 120 145 110"
          stroke={trunkColor}
          strokeWidth="4"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M65 140 Q50 120 35 100 Q25 90 20 80"
          stroke={trunkColor}
          strokeWidth="3"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M105 130 Q120 110 135 90 Q145 80 150 70"
          stroke={trunkColor}
          strokeWidth="3"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M85 120 Q80 90 75 70 Q70 50 65 35"
          stroke={trunkColor}
          strokeWidth="3"
          strokeLinecap="round"
          fill="none"
        ...
        {/* Blossom clusters - large background blobs */}
        ...
        {/* Individual blossom dots for texture */}
        {[
          [60, 40], [80, 50], [100, 45], [45, 70], [70, 30],
          [90, 60], [110, 35], [55, 55], [75, 75], [120, 60],
          [35, 85], [130, 50], [65, 25], [85, 65], [105, 70],
          [50, 45], [95, 25], [115, 80], [40, 60], [80, 85],
        ].map(([cx, cy], i) => (
          <circle
            key={i}
            cx={cx}
            cy={cy}
            r={5 + Math.random() * 8}
            fill={blossomColors[i % blossomColors.length]}
          />
        ))}
      </svg>
    </div>
    ...
    <div style={style}>
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        <path
          ...
          fill="rgba(242, 205, 211, 0.7)"
          stroke="rgba(230, 173, 176, 0.4)"
          strokeWidth="0.5"
        />
        <path
          d="M12 2C12 2 16 6 16 10C16 12.2 14.2 14 12 14C9.8 14 8 12.2 8 10C8 6 12 2 12 2Z"
          fill="rgba(250, 240, 242, 0.5)"
          stroke="rgba(242, 205, 211, 0.3)"
          strokeWidth="0.5"
        />
...
export function CherryBlossomsBackground() {
  ...
  return (
    ...
    >
      ...
      >
        {trees.filter(t => t.layer === 'far').map((tree, i) => (
          <CherryTreeSVG key={`far-${i}`} tree={tree} />
        ))}
      </div>
      ...
      >
        {trees.filter(t => t.layer === 'mid').map((tree, i) => (
          <CherryTreeSVG key={`mid-${i}`} tree={tree} />
        ))}
      </div>
      ...
      >
        {trees.filter(t => t.layer === 'near').map((tree, i) => (
          <CherryTreeSVG key={`near-${i}`} tree={tree} />
        ))}
      </div>
